...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error(`API Route /builds/[id] (index.ts variant): Critical error fetching settings:`, settingsError);
  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      console.error(`Error fetching build ${id} (index.ts variant):`, error);
